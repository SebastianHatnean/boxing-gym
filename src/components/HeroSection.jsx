...
export function HeroSection({ brand, hero, stats }) {
  ...
  return (
    <section id="home" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto grid min-h-[calc(100svh-81px)] max-w-7xl items-center gap-16 px-5 py-16 md:px-8 lg:grid-cols-[1.1fr_1fr] lg:py-20">
        <Motion.div
        ...
        >
          ...
          <Motion.div
            ...
            className="absolute -left-6 bottom-10 z-20 hidden w-52 rounded-3xl border border-white/10 bg-black/70 p-5 shadow-2xl lg:block"
          >
